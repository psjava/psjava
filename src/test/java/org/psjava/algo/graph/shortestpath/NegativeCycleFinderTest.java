...
public class NegativeCycleFinderTest {
	...
	public void testNegativeCycleV2() {
		...
		NegativeCycleFinderResult<SimpleDirectedWeightedEdgeV2<Integer, Integer>> r = NegativeCycleFinder.find(g, g.getWeightFunction(), IntegerNumberSystem.getInstance());
