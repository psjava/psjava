...
public class SingleSourceShortestPathTestCommon {
    ...
    public static void testSizeOneGraph(SingleSourceShortestPathAlgorithmV2 algo) {
        int[][] data = {{0, 0, 100}};
    ...
    public static void testNotReachableVertex(SingleSourceShortestPathAlgorithmV2 algo) {
    ...
    public static void testCLRSExample(SingleSourceShortestPathAlgorithmV2 algo) {
