...
public class RootedTreeTesterTest {
	...
	public void testOk() {
		...
		Assert.assertTrue(RootedTreeTester.is(TestGraphFactory.createDirected(data), "A"));
	}

	@Test
	public void testCycled() {
		String[][] data = new String[][] { { "A", "B" }, { "B", "A" } };
		Assert.assertFalse(RootedTreeTester.is(TestGraphFactory.createDirected(data), "A"));
	}
